...
Namespace LightSwitchApplication
    ...
    Public Class Tracker_IRT
        ...
        Private Sub Tracker_IRT_Created()
            MaxFitList = "0"
            Type = "TAC Tracking"
            Priority = "2"
            TrackerList = "Yes"
        ...
        Private Sub SendOrder_Execute()
            ...
            Dim sendarray = From detail In TrackerIRT
            ...
            For Each d In sendarray
                ...
                Else
                    ...
                    With newEmail
                        ...
                        .Message = "Tracker Needed: " + Type + " " + Location + " " + "Priority: " + Priority + " Staging at " + StagingArea + ". Call (865)436-1230."
                    End With
